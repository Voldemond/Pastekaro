      ...
      <div className="relative w-full max-w-2xl backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-8">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-gray-400 mb-2">Share text securely with auto-expiry and view limits.</p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            {status === 'loading' ? (
              ...
              <>
                ...
                <Link
                  href="/dashboard"
                  className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 rounded-lg text-sm font-medium transition-all text-center"
                >
                  📊 My Dashboard
                </Link>
                <button
              ...
              <>
                <Link
                  href="/auth/login"
                  className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg text-sm transition-colors text-center border border-white/20"
                >
                  Login
                </Link>
                <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-black/30 border border-white/10 rounded-xl p-3 text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500 placeholder-gray-500"
                value={ttl}
        ...
        {!session && (
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg text-center">
            <p className="text-sm text-blue-200">
              💡 <Link href="/auth/signup" className="underline font-medium">Sign up</Link> to save pastes permanently and organize them into packages!
            </p>
          </div>
        )}
